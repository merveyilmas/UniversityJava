...
public class FindMaxMinValue {
	public static void main(String[] args) {
		...
		/*
		 * Her satýrdaki en büyük ve en küçük elemanlarýn bulunmasý
		 */
		/*
		...
		/*
		 * Her sütundaki en büyük ve en küçük elemanýn bulunmasý
		 */

		/*
		 * Ek olarak tablodaki en büyük ve en küçük elemanýn bulunmasý
		 */
		enKucuk = 3.4e38;
		enBuyuk = -3.4e38;
		for (j = 0; j <= 3; j++) {
